...
const PopularPage = () => {
  ...
  queryKey: ["moviesInf", filters],
  initialPageParam: 1, 
  queryFn: ({ pageParam }) => fetchPopularOrTopRatedMovies({ pageParam, filters }),
  ...
  return (
    <Container maxWidth="xl" sx={{ my: 2, px: { xs: 2.5, sm: 2 } }}>
      ...
      >
        ...
        >
          <SidebarFilter setFilters={setFilters} initialSort="popularity.desc" />
        </Box>
